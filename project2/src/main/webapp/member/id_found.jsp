...
<div class="main_box">
	<div class="login_main_box">
		<div class="login_login_box"><!-- 에러시 확인 style 없음 -->
			...
			<form action="member_id_found_ok" method="post" onsubmit="return go()">
				<div class="login_main_name">아이디 찾기</div>
				<div id="height_10"></div>
				<div class="login_name_box">이름</div>
				<div class="login_name_box"><input type="text" id="name" name="name" maxlength="16" class="login_input_box"></div>
