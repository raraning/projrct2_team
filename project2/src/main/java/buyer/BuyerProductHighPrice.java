...
@WebServlet("/buyer/buyer_product_highprice")
public class BuyerProductHighPrice extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public BuyerProductHighPrice() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> highprice = dao.getHighPriceProduct(startRow, endRow, field, search, pro_class, category);
	    ...
	    request.setAttribute("v", highprice);
