...
<form name="join" action="admin_join_update" method="post" onsubmit="return go()">
<div class="main_box">
	<div class="join_main_box">
		<div class="join_join_box"><!-- 에러시 확인 style 없음 -->
			...
			<div class="join_mid_box">
				...
				<div class="join_name_box"><input type="text" id="level" name="level" value="${mem.level }" class="join_input_box"></div>
				
				<div class="join_name_box">구메,판매</div>
				<c:choose>
						<c:when test="${mem.sell_buy == 'X' }">
						...
						<c:otherwise>
							<input type="radio" id="sell_buy" name="sell_buy" value="X" class="join_input_jender">구메자
							<input type="radio" id="sell_buy" name="sell_buy" value="Y" class="join_input_jender"checked>구메, 판매자
						</c:otherwise>
					</c:choose>
				
				<div class="join_name_box">제품 회사</div>
				<div class="join_name_box"><input type="text" id="pro_manuname" name="pro_manuname" value="${mem.pro_manuname }" class="join_input_box"></div>
				<div class="join_name_box">판매자 명</div>
				<div class="join_name_box"><input type="text" id="pro_salname" name="pro_salname" value="${mem.pro_salname }" class="join_input_box"></div>
				<div id="height_30"></div>
				<br>
				<div class="join_main_name"><button class="join_button_box">회원수정</button></div>
			</div>	
			<div id="w20_left"></div>
		</div>
	</div>
