...
public class Cart {
	...
	public String toString() {
		return "Cart [uid=" + uid + ", pro_uid=" + pro_uid + ", pro_name=" + pro_name + ", pro_id=" + pro_id + ", id="
				+ id + ", cart_session=" + cart_session + ", pro_price=" + pro_price + ", pro_point=" + pro_point
				+ ", pro_count=" + pro_count + ", pay_ok=" + pay_ok + "]";
	}
