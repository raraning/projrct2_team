...
@WebServlet("/recipe/recipe_comment_modify")
public class ModifyCommentRecipe extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public ModifyCommentRecipe() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("recipe_comment_modify.jsp");
