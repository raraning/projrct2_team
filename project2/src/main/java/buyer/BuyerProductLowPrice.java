...
@WebServlet("/buyer/buyer_product_lowprice")
public class BuyerProductLowPrice extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public BuyerProductLowPrice() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> lowprice = dao.getLowPriceProduct(startRow, endRow, field, search, pro_class, category);
	    ...
	    request.setAttribute("v", lowprice);
