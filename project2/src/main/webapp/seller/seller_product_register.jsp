...
String today2 = sf2.format(nowTime2);
%>
...
<div>
	...
	<div style="width:900px; display:inline-block;">
		<div class="pro_title">SHARE MARKET 판매 상품 등록하기</div>
		<div style="height:20px;"> </div>
	<form action="product_register_insert" method="post" enctype="multipart/form-data" onsubmit="return pro_write();">
		...
		<div class="pro_info">
			...
			<div class="pro_name1 pnleft"><font color="#4b3c8e"><b>제조사명</b></font> <img src="/img/right.png" width=13 height=13> <input id="pro_manuname" name="pro_manuname" value="${member.pro_manuname }" readonly></div>
			<div class="pro_name1" style="width:50px;"> </div>
			<div class="pro_name1 pnleft"><font color="#4b3c8e"><b>판매업체명</b></font> <img src="/img/right.png" width=13 height=13> <input id="pro_salname" name="pro_salname" value="${member.pro_salname }" readonly></div>
		</div>
		<div style="height:10px;"> </div>	
		<div class="pro_name2">&nbsp;&nbsp;<input id="pro_name" name="pro_name" placeholder="상품명을 입력해주세요"></div>
		<div style="height:10px;"> </div>
		<!-- 카테고리 및 수량 입고날짜 시작 -->
		<div>
			<div class="pro_mid">
				...
				<div class="pmleft2">
					...
					<span id="fresh_category">
						<select id="pro_category" name="pro_category">
							...
							<option value="채소/쌀/잡곡">채소/쌀/잡곡</option>
					...
					<span id="freeze_category" style="display:none;">
						<select id="pro_category" name="pro_category">
							<option value="" selected disabled hidden>선택하세요</option>
							<option value="냉장/냉동/간편요리">냉장/냉동/간편요리</option>
							<option value="수산물/냉동육류">수산물/냉동육류</option>
							<option value="생수/음료">생수/음료</option>
						</select>
					</span>
					<span id="process_category" style="display:none;">
						<select id="pro_category" name="pro_category">
							<option value="" selected disabled hidden>선택하세요</option>
							<option value="유제품/아이스크림">유제품/아이스크림</option>
							<option value="장/소스/드레싱/식초">장/소스/드레싱/식초</option>
							<option value="과자/초콜릿/시리얼">과자/초콜릿/시리얼</option>
						</select>
					</span>
				</div>
						...
						<div class="pmright1">
							...
							<input id="pro_available" name="pro_available" placeholder="수량을 입력하세요">
						</div>
						<div class="pmright2">
							<div class="pro_indate">입고 날짜</div>
							  Today <input id="pro_indate" name="pro_indate" value="<%=today2%>" readonly>
						</div>
					</div>
		</div>
		<!-- 카테고리 및 수량 입고날짜 끝 -->
		...
		<div class="pmleft3">
			<div class="pro_price">상품 가격</div>
				<div class="pp1"><input id="pro_price" name="pro_price" onkeyup="inputNumberFormat(this)" placeholder="가격을 입력하세요">원</div>
			<div class="pro_point">&nbsp;마일리지 금액(1%자동 적립) : </div>
				<input id="pro_point" name="pro_point" readonly>원
		</div>
		<!-- 가격과 마일리지 끝 -->
		<!-- 대표사진(사진첨부) 시작 -->
		<div style="height:10px;"> </div>
		<div class="pro_bottom">
			...
			<div class="pro_file">
				...
				<div><label class="input_file_button" for="file1"><img id="file1img" src="/img/camera.png" width=70 height=70 title="클릭하여 파일선택"></label><input type="file" name="file1" id="file1" accept="image/*" style="display:none;"></div>
				<div>상품 대표 사진</div>
			</div>
			<div class="pfempty"></div>
			<div class="pro_file">
				<div style="height:10px;"> </div>
				<div><label class="input_file_button" for="file2"><img id="file2img" src="/img/camera.png" width=70 height=70 title="클릭하여 파일선택"></label><input type="file" name="file2" id="file2" accept="image/*" style="display:none;"></div>
				<div>&nbsp;&nbsp;추가 사진1</div>
			</div>
			<div class="pfempty"></div>
			<div class="pro_file">
				<div style="height:10px;"> </div>
				<div><label class="input_file_button" for="file3"><img id="file3img" src="/img/camera.png" width=70 height=70 title="클릭하여 파일선택"></label><input type="file" name="file3" id="file3" accept="image/*" style="display:none;"></div>
				<div>&nbsp;&nbsp;추가 사진2</div>
			</div>
		</div>
		<!-- 대표사진(사진첨부) 끝 -->
		...
		<div>
			<textarea name="pro_detailing" id="pro_detailing"></textarea>
		</div>
		<div style="height:5px;"> </div>
		<div>
			<div class="pro_button pb1"><a href="seller_product_list">등록상품 리스트</a></div>
			<div class="pro_button pb2"></div>
			<div class="pro_button pb3"><button>등록하기</button></div>
		</div>
		</form>
	</div>
