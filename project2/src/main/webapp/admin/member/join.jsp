...
<form name="join" action="admin_join_insert" method="post" onsubmit="return go()">
<div class="main_box">
	<div class="join_main_box">
		<div class="join_join_box"><!-- 에러시 확인 style 없음 -->
			...
			<div class="join_mid_box">
				...
				<div class="join_main_name">회원가입</div>
				<br>
				<span onclick="join_go()">회원가입 방법</span>
				<br>
				<div id="height_10"></div>
				<div class="join_name_box">아이디</div>
				<div class="join_name_box">
					<div class="join_id_box"><input type="text" id="id" name="id" value="" placeholder="중복확인 눌러주세요" maxlength="16" class="join_id_input_box"></div>
					<div class="join_id_check_box"><span onclick="admin_id_select(join.id.value)">중복확인</span>
					<br>
					</div>
				</div>
				<div id="height_20"></div>
				...
				<div class="join_name_box"><input type="text" id="name2" name="name" value="" placeholder="이름을 입력하세요(10자이내)" maxlength="10" class="join_input_box"></div>
				<div id="height_20"></div>
				<div class="join_name_box">생년월일</div>
				<div class="join_name_box"><input type="date" id="birth" name="birth" value="" placeholder="-없아 압력" maxlength="8" class="join_input_box"></div>
				<div id="height_20"></div>
				...
				<div class="join_name_box"><input type="email" id="email" name="email" value="" placeholder="이메일을 입력하세요(25자 이내)" maxlength="25" class="join_input_box"></div>
				<div id="height_20"></div>
				<div class="join_name_box">주소</div>
				...
				<div id="height_20"></div>
				<div class="join_name_box">레벨</div>
				<div class="join_name_box"><input type="text" id="level" name="level" value="1" class="join_input_box"></div>
				<div class="join_name_box">구메,판매</div>
				<div class="join_name_box">
					<input type="radio" id="sell_buy" name="sell_buy" value="X" class="join_input_jender" checked>구메자
					<input type="radio" id="sell_buy" name="sell_buy" value="Y" class="join_input_jender">구메,판매자
				</div>
				<div class="join_name_box">제품 회사</div>
				<div class="join_name_box"><input type="text" id="pro_manuname" name="pro_manuname" class="join_input_box"></div>
				<div class="join_name_box">판매자 명</div>
				<div class="join_name_box"><input type="text" id="pro_salname" name="pro_salname" class="join_input_box"></div>
