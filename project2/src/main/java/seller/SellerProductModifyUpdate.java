...
@WebServlet("/seller/product_modify_insert")
@MultipartConfig(
		fileSizeThreshold=0,
		location = "C:\\jsp\\project2\\src\\main\\webapp\\upload"
	)
public class SellerProductModifyUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public SellerProductModifyUpdate() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sp.setPro_uid(Integer.parseInt(request.getParameter("pro_uid")));
